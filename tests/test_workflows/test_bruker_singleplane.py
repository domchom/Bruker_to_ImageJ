...
def default_parameters():
    folder_path = 'tests/test_data/bruker_singleplane'
...
def test_bruker_singleplane_workflow(default_parameters):
    loaded_arrays = np.load('tests/assets/bruker_singleplane_hyperstack_arrays.npz')
